...
public class BenchmarkInvariant {
    ...
    @Warmup(iterations = 3, time = 3)
    @Measurement(iterations = 5, time = 5)
    public void invariant_5000(Blackhole hole, Input input) {
        hole.consume(input.subject5000.target(input.x));
    }
    ...
    public static class Input {
        ...
        public InvariantSubject5000 subject5000 = new InvariantSubject5000();
        public int x = -1;
    }
}
